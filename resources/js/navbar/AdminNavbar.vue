...
export default {
  data() {
        return {
            ...
            drawer: false,
            items: [
                { title: 'Dashboard', link:'/admin/dashboard/home', icon: 'view-dashboard' },
                { title: 'Post', link:'/admin/dashboard/post', icon: 'post' },
                { title: 'Accounts', link:'/admin/dashboard/accounts', icon: 'account-box-multiple' },
            ]
        }
    },
    computed: {
